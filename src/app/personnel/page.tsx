            ...
            {isLoadingPersonnel ? (
              ...
              <Table>
                ...
                <div className="flex flex-col items-center justify-center rounded-md border-2 border-dashed p-12 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Try adjusting your search or add new personnel.</p>
                </div>
            )}
          </CardContent>
        </Card>
        <AddPersonnelForm
            open={showAddPersonnelForm}
            onOpenChange={setShowAddPersonnelForm}
        />
      </main>
    </div>
  );
